...
class DMETProblemDecompositionSingle:
    ...
    def simulate(self, molecule, fragment_atoms, mean_field=None):
        ...
        chemical_potential = self._oneshot_loop(chemical_potential, orbitals,
                                                orb_list, orb_list2, energy)
    ...
    def _oneshot_loop(self, chemical_potential, orbitals, orb_list, orb_list2,
        ...
        for i, norb in enumerate(orb_list):
            ...
            del bath_orb, e_occupied
            del norb_high, nelec_high, onerdm_high
            del one_ele, fock, two_ele
            del guess_orbitals
            del mf_fragment, fock_frag_copy, mol_frag
            del cc_onerdm, cc_twordm
            del fragment_energy, total_energy_rdm, one_rdm
